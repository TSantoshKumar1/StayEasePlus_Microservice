package com.service.user.myconfig;

import com.service.user.webConfig.interceptor.RestTemplateInterceptors;
...
public class UserConfig {
    ...
    interceptors.add(new RestTemplateInterceptors(manager(clientRegistrationRepository,oAuth2AuthorizedClientRepository)));
